...
st.set_page_config(page_title="💌 For Favour", page_icon="❤️", layout="centered")
...
# ------------------ App ------------------
st.markdown("<div class='big'>💖 Hey Favour 😊</div>", unsafe_allow_html=True)
...
if not st.session_state.accepted:
    ...
    st.markdown("### Favour just unlocked Valentine mode 💕")
    ...
    draw.text((170, 140), "Favour’s Valentine", fill="#000000", font=font_small)
